 ...
 */
export async function triggerVideoDiscovery(payload: Events["tiktok/video.discovery.manual"]["data"]) {
 ...
 */
export async function deactivateKillSwitch(payload: Events["tiktok/system.deactivate_kill_switch"]["data"]) {
  return await inngest.send({
